 ...
 * {@link org.apache.kafka.connect.data.Schema} excludes any columns that have been {@link SingleStoreConnectorConfig#COLUMN_EXCLUDE_LIST specified} in the
 * configuration.
 */
public class SingleStoreDatabaseSchema extends RelationalDatabaseSchema {

    public SingleStoreDatabaseSchema(SingleStoreConnectorConfig config, SingleStoreValueConverters valueConverter,
                                       SingleStoreDefaultValueConverter defaultValueConverter, TopicNamingStrategy<TableId> topicNamingStrategy,
    ...
    private static TableSchemaBuilder getTableSchemaBuilder(SingleStoreConnectorConfig config, SingleStoreValueConverters valueConverter,
                                                            SingleStoreDefaultValueConverter defaultValueConverter) {
        return new SingleStoreTableSchemaBuilder(valueConverter, defaultValueConverter, config.schemaNameAdjuster(),
     ...
     */
    protected SingleStoreDatabaseSchema refresh(SingleStoreConnection connection) throws SQLException {
