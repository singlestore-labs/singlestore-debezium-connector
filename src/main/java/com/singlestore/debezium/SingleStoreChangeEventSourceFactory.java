...
public class SingleStoreChangeEventSourceFactory implements
    ChangeEventSourceFactory<SingleStorePartition, SingleStoreOffsetContext> {
  ...
  public SnapshotChangeEventSource<SingleStorePartition, SingleStoreOffsetContext> getSnapshotChangeEventSource(
    ...
    return new SingleStoreSnapshotChangeEventSource(connectorConfig, connectionFactory, schema,
  ...
  public StreamingChangeEventSource<SingleStorePartition, SingleStoreOffsetContext> getStreamingChangeEventSource() {
    return new SingleStoreStreamingChangeEventSource(connectorConfig,
        connectionFactory.mainConnection(), dispatcher, errorHandler, schema, clock);
  }
