...
public class SingleStoreDBCancellableResultSet implements ResultSet {

    private final ResultSet resultSet;

    private SingleStoreDBCancellableResultSet(ResultSet resultSet) {
        this.resultSet = resultSet;
    }

    public static SingleStoreDBCancellableResultSet from(ResultSet resultSet) {
        return new SingleStoreDBCancellableResultSet(resultSet);
    }
