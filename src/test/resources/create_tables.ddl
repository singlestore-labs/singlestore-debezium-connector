...
CREATE ROWSTORE TABLE IF NOT EXISTS db.allTypesTable (
    ...
    `vectorI8Column` VECTOR(3, I8) DEFAULT '[1, 10, 100]',
    `vectorI16Column` VECTOR(3, I16) DEFAULT '[1, 10, 100]',
    `vectorI32Column` VECTOR(3, I32) DEFAULT '[1, 10, 100]',
    `vectorI64Column` VECTOR(3, I64) DEFAULT '[1, 10, 100]',
    `vectorF32Column` VECTOR(3, F32) DEFAULT '[1.1, 10.1, 100.1]',
    `vectorF64Column` VECTOR(3, F64) DEFAULT '[1.1, 10.1, 100.1]',
