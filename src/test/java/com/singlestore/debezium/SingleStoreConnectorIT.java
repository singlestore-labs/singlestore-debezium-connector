...
public class SingleStoreConnectorIT extends IntegrationTestBase {
    ...
    public void shouldValidateAcceptableConfiguration() {
        ...
        validateConfigField(result, SingleStoreConnectorConfig.DECIMAL_HANDLING_MODE, DecimalHandlingMode.PRECISE);
        validateConfigField(result, SingleStoreConnectorConfig.TIME_PRECISION_MODE, TemporalPrecisionMode.ADAPTIVE);
        validateConfigField(result, SingleStoreConnectorConfig.TOPIC_NAMING_STRATEGY, DefaultTopicNamingStrategy.class.getName());
