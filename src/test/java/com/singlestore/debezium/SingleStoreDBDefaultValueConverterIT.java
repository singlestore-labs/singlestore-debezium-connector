    ...
    public void testDefaultTimeAndDateValues() {
        try (SingleStoreDBConnection conn = new SingleStoreDBConnection(defaultJdbcConnectionConfig())) {
            ...
            testColumn(defaultValueConverter, table, "datetimeColumn",
                    Date.from(LocalDateTime.of(2023, 12, 31, 23, 59, 59).atZone(ZoneId.of("UTC")).toInstant()).getTime());
            testColumn(defaultValueConverter, table, "datetime6Column",
                    Date.from(LocalDateTime.of(2023, 12, 31, 22, 59, 59, 111111).atZone(ZoneId.of("UTC")).toInstant()).getTime() * 1_000 + 111111);
            testColumn(defaultValueConverter, table, "timestampColumn",
                    Date.from(LocalDateTime.of(2022, 1, 19, 3, 14, 7).atZone(ZoneId.of("UTC")).toInstant()).getTime());
...
//                    Date.from(LocalDateTime.of(2022, 1, 19, 3, 14, 7, 111111).atZone(ZoneId.of("UTC")).toInstant()).getTime() * 1_000 + 111111); //todo uncomment after DB issued with defaultValue is fixed: DB-65291
    ...
    public void testStringValues() {
        try (SingleStoreDBConnection conn = new SingleStoreDBConnection(defaultJdbcConnectionConfig())) {
            ...
            testColumn(defaultValueConverter, table, "varbinaryColumn", ByteBuffer.wrap("abc".getBytes()));
