...
public class SourceInfoTest {
  ...
  public void versionIsPresent() {
    assertThat(source.struct().getString(SourceInfo.DEBEZIUM_VERSION_KEY)).isEqualTo(
        Module.version());
  }

  @Test
  public void connectorIsPresent() {
    assertThat(source.struct().getString(SourceInfo.DEBEZIUM_CONNECTOR_KEY)).isEqualTo(
        Module.name());
  }
  ...
  public void timestampIsPresent() {
    assertThat(source.struct().getInt64("ts_ms")).isEqualTo(
